...
#from beagle_analysis import wrap_make_photometry_plots, my_print_ID, my_other_print_ID
...
if __name__ == '__main__':
    ...
    # ********* Compute ***************
    #file_list = ("1021_BEAGLE.fits.gz", "5866_BEAGLE.fits.gz")
    #for file in os.listdir(results_dir):
    #    if file.endswith("BEAGLE.fits.gz"):
